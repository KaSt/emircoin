...
This document provides guidelines for internationalization of the Emircoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `emircoin_en.ts` remains unchanged.
