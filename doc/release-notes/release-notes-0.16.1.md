Emircoin Core version 0.16.1 is now available from:

  <https://emircoincore.org/bin/emircoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting emircoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure emircoind processes are cleaned up when tests end (sdaftuar)
