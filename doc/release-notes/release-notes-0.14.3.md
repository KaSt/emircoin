Emircoin Core version *0.14.3* is now available from:

  <https://emircoin.org/bin/emircoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/emircoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
