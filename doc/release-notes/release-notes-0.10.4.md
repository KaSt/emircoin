Emircoin Core version 0.10.4 is now available from:

  <https://emircoin.org/bin/emircoin-core-0.10.4/>
...
- #6953 `43c2789` Split emircoin-tx into its own package
- #6953 `dfe0d4d` Include emircoin-tx binary on Debian/Ubuntu
