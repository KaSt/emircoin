Emircoin Core version 0.9.4 is now available from:

  https://emircoin.org/bin/0.9.4/
...
this update is incompatible with the Emircoin system and could lead to consensus
forks.

Emircoin Core released binaries from https://emircoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~emircoin/+archive/ubuntu/emircoin
- A third-party or self-compiled Emircoin Core

upgrade to Emircoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
