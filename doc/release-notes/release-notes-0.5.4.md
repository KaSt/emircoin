Emircoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/emircoin/files/Emircoin/emircoin-0.5.4/
...
http://gitorious.org/emircoin/emircoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Emircoin-Qt notifications under Growl 1.3.
Increase required age of Emircoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEmircoin properly when installing Emircoin-Qt over it. (Windows)
