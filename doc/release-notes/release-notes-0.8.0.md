Emircoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/emircoin/files/Emircoin/emircoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Emircoin
...
New/changed settings (command-line or emircoin.conf file)
--------------------------------------------------------
