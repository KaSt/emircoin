Emircoin Core version 0.13.2 is now available from:

  <https://emircoin.org/bin/emircoin-core-0.13.2/>
...
- #8908 `4a974b2` Update emircoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow emircoin-tx to create v2 transactions (btcdrak)
