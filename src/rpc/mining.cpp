        ...
        throw std::runtime_error(
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated emircoin to."},
            ...
            + "If you are running the emircoin core wallet, you can get a new address to send the newly generated emircoin to with:\n"
...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/emircoin/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/emircoin/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/emircoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/emircoin/bips/blob/master/bip-0145.mediawiki\n",
                {
    ...
    if (setClientRules.count(segwit_info.name) != 1 && ::ChainActive().Tip()->nHeight > 2000) {
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2) {
        throw std::runtime_error(
            RPCHelpMan{"submitblock",
                ...
                "See https://en.emircoin.it/wiki/BIP_0022 for full specification.\n",
                {
