...
#ifndef EMIRCOIN_TEST_SCRIPTNUM10_H
#define EMIRCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Emircoin Core 0.10.0, for cross-comparison.
 */
public:
