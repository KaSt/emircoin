...
#ifndef EMIRCOIN_WALLET_WALLET_H
#define EMIRCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! emircoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Emircoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this emircoin node, and set to 0 for transactions that were created
...
#endif // EMIRCOIN_WALLET_WALLET_H
