...
#ifndef EMIRCOIN_QT_SPLASHSCREEN_H
#define EMIRCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Emircoin Core initialization
...
#endif // EMIRCOIN_QT_SPLASHSCREEN_H
