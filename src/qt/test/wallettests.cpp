...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<EmircoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_emircoin-qt -platform xcb      # Linux
//     src/qt/test/test_emircoin-qt -platform windows  # Windows
//     src/qt/test/test_emircoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = EmircoinUnits::formatWithUnit(unit, balance, false, EmircoinUnits::separatorAlways);
    ...
    // Amount input
    EmircoinAmountField* amountInput = receiveCoinsDialog.findChild<EmircoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: emircoin:")) != -1);
