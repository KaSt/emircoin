    ...
    mapper(nullptr)
{
    ...
    ui->emircoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->emircoinAtStartup);
    ...
    ui->emircoinAtStartup->setToolTip(ui->emircoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->emircoinAtStartup->setText(ui->emircoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openEmircoinConfButton->setToolTip(ui->openEmircoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new EmircoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->emircoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openEmircoinConfButton_clicked()
{
