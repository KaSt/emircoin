    ...
    platformStyle(_platformStyle)
{
    ...
    // normal emircoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying emircoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &EmircoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
