...
#ifndef EMIRCOIN_QT_EMIRCOINUNITS_H
#define EMIRCOIN_QT_EMIRCOINUNITS_H
...
/** Emircoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EmircoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EmircoinUnits(QObject *parent);

    /** Emircoin units.
      @note Source: https://en.emircoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef EmircoinUnits::Unit EmircoinUnit;

#endif // EMIRCOIN_QT_EMIRCOINUNITS_H
