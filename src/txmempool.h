...
#ifndef EMIRCOIN_TXMEMPOOL_H
#define EMIRCOIN_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/emircoin/emircoin/pull/14193 will fix it. No known code
     * in emircoin currently depends on second guarantee, but it is important to
