...
#ifndef EMIRCOIN_INTERFACES_NODE_H
#define EMIRCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a emircoin node (emircoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // EMIRCOIN_INTERFACES_NODE_H
