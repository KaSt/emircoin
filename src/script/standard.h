...
#ifndef EMIRCOIN_SCRIPT_STANDARD_H
#define EMIRCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a emircoin address
 */
...
/**
 * Generate a Emircoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // EMIRCOIN_SCRIPT_STANDARD_H
