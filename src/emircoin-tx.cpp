...
static void SetupEmircoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " emircoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  emircoin-tx [options] <hex-tx> [commands]  Update hex-encoded emircoin transaction\n" +
            "or:     emircoin-tx [options] -create [commands]   Create hex-encoded emircoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded emircoin transaction
