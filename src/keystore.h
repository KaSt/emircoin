...
#ifndef EMIRCOIN_KEYSTORE_H
#define EMIRCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/emircoin/bips/blob/master/bip-0013.mediawiki
