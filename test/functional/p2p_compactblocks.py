...
# TestP2PConn: A peer we use to send messages to emircoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes emircoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that emircoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for emircoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # emircoind will not send blocktxn responses for blocks whose height is
