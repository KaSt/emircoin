...
"""Verify that starting emircoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start emircoin with -h for help text")
        ...
        self.log.info("Start emircoin with -version for version information")
        ...
        self.log.info("Start emircoind with -fakearg to make sure it does not start")
