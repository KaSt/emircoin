...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the emircoin repository."
  exit 1
fi
...
# See https://github.com/emircoin/emircoin/issues/16064
...
echo
echo 'When compiling emircoind, run `./configure` in the following way:'
echo
