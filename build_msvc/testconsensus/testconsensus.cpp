...
// emircoin includes.
#include <..\src\script\emircoinconsensus.h>
...
int main()
{
    std::cout << "emircoinconsensus version: " << emircoinconsensus_version() << std::endl;
    ...
    auto op0Result = emircoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, emircoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
